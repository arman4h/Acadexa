...
export function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 border-b border-[#EAECEF] bg-[#FAFBFD]/80 backdrop-blur-md">
      <div className="mx-auto max-w-6xl px-6">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-1">
            ...
            <Link
              to="/search"
              className="ml-2 p-2 rounded-xl text-[#6B7280] hover:text-[#1F2937] hover:bg-[#EAECEF]/50 transition-all duration-150"
            >
          ...
          <button
            className="md:hidden p-2 rounded-xl text-[#6B7280] hover:bg-[#EAECEF]/50 transition-all duration-150 cursor-pointer"
      ...
      {mobileOpen && (
        <div className="md:hidden border-t border-[#EAECEF] bg-white px-6 py-4 animate-[fadeIn_150ms_ease]">
